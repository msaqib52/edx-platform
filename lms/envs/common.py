...
FEATURES = {
    ...
    #    and applications.
    # .. toggle_warnings: After enabling this feature flag you need to run database migrations which will create
    #    database tables required for LTI provider functionality.
    # .. toggle_use_cases: open_edx
    # .. toggle_creation_date: 2015-06-27
    # .. toggle_tickets: https://github.com/edx/edx-platform/pull/8620
